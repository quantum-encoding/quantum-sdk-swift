...
// MARK: - Agent Event (legacy shapes)

/// Legacy shape kept only for source compatibility with the core event
/// parsers; nothing in this SDK produces it. Use ``AgentStreamEvent``.
